...
{
    // Stop the camera HTTP server
    if (camera_httpd != NULL)
    {
        httpd_stop(camera_httpd);
        camera_httpd = NULL; // Set the pointer to NULL to indicate it's stopped
        log_i("Camera server stopped");
    }

    // Stop the stream HTTP server
    if (stream_httpd != NULL)
    {
        httpd_stop(stream_httpd);
        stream_httpd = NULL; // Set the pointer to NULL to indicate it's stopped
